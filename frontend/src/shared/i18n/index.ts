...
const resources = {
  'zh-CN': { translation: {
    ...
    shell: { home: '工作台', dashboard: '运行概览', chat: '安全对话', workflow: '工作流', skills: 'Skills', mcp: 'MCP', knowledge: '知识库', trace: '观测', memory: '记忆', evaluations: '评估', approvals: '审批', scheduler: '调度', cve: 'CVE', collect: 'Collect', audit: '审计', settings: '设置', logout: '退出登录', theme: '切换主题', language: '切换语言' },
  } },
  'en-US': { translation: {
