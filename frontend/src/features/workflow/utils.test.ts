...
const state: WorkflowState = {
  ...
  selectedId: null,
  steps: [
    { id: 'a', kind: 'agent', targetId: 'triage', name: 'Triage', instructions: 'inspect' },
    { id: 'b', kind: 'team', targetId: 'soc', name: 'SOC', instructions: 'contain' },
  ],
}
describe('workflow behavior', () => {
  ...
  it('preserves execution and session settings in generated code', () => {
    const code = buildWorkflowCode(state)
    expect(code).toContain('executor_id')
