...
const workspaces = [
  ...
  { to: '/knowledge', code: 'DATA-03', title: '知识控制', description: '管理检索资产、可见性与入库流水线。', signal: 'INDEXED' },
  ...
  return (
    <main className="home-page">
      <section className="home-command">
        <div><Tag bordered={false}>TRINITY AI SECURITY</Tag><Typography.Title>T.A.I.S 控制面</Typography.Title><Typography.Paragraph>面向安全运营人员的 Agent 运行、知识、观测与治理工作台。</Typography.Paragraph></div>
