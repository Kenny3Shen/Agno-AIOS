...
export interface Skill { name: string; description: string; enabled: boolean; has_scripts: boolean; scripts: string[]; attachments?: string[]; skill_markdown: string; visibility: ResourceVisibility; owner_user_id: string; can_manage: boolean }
