...
T.A.I.S 是一个面向安全运营的 AI 工作台。后端提供认证、权限、运行时编排、MCP、知识库、Trace、Memory、Evaluation、Approval、Scheduler 和 CVE 能力；前端提供统一工作台。
...
- `vue`：旧版 Vue + Element Plus。
- `master`：新版 React 19 + TanStack + Ant Design v6。
